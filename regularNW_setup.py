...
################################################################
try:
	from network_setups import RegularNW
...
############
	...
	##################
	# baseUDF の作成
	baseudf = SetupInitUDF.MakeInitUDF(sim_cond, target_cond, files_cond, names, target_name, calcd_data_dic, expand, condition_text)
